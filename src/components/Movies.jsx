    ...
    setVisibleMovies((prevVisibleMovies) => prevVisibleMovies + 6);
      ...
      const fetchAllMovies =async () =>{
        try{
            ...
            const allMovies = await useFetch('https://api.themoviedb.org/3/discover/movie?api_key=00357191f7f962b0db2d77089228f80d');
            setMovies(allMovies);
        ...
        <>
            <section  style={sectionStyle}>
                ...
                <div className=' flex items-center flex-col justify-center ' data-aos-easing="ease-in-sine"  data-aos-duration="3000"  data-aos='fade-right'>
                    <h1 className='uppercase text-white font-bold  text-8xl md:text-9xl text-center text-shadow-lg'   >NEW MOVIES  </h1>
                    <p className='lead uppercase text-white  text-center font-bold my-5 text-5xl'>Taste our new movies  journey  </p>
            ...
            <section className="bg-gray-900">
                <div  className=" container grid md:grid-cols-5  text-center md:text-left  m-auto  gap-2 py-12">
                    <div className='py-4'>
                        <h1 className='text-4xl text-white font-bold'>Popular Movies to Watch Now</h1>

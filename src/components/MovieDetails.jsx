...
export default function MovieDetails () {
  ...
  if (!movie) {
    return <div class="border-gray-300 flex justify-center  m-auto h-20 w-20 animate-spin rounded-full border-8 border-t-blue-600"></div>
  }
    return (
        <div>
          <section className='bg-gray-900 py-5 text-white'>
                ...
                <div data-aos="fade-left" class="md:w-full m-5 p-4   overflow-hidden shadow-lg  flex md:m-auto justify-center">
                    ...
                    <div  data-aos="fade-right" class="flex flex-col p-5   flex-grow md:px-8 md:py-4 rounded-lg bg-white text-gray-900">
